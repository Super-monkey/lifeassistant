...
public class LifeFragment extends Fragment {
    ...
    private MyGridLayout lifeLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lifeLayout = (MyGridLayout) view.findViewById(R.id.frag_home_lifelayout);
        lifeLayout.setGridAdapter(new GridLayoutAdapter(getContext(), srcs, titles));
        lifeLayout.setOnItemClickListener(new MyGridLayout.OnItemClickListener() {
            @Override
