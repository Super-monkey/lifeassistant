 ...
 * @github https://github.com/zcweng/SwitchButton.git
 */
public class SwitchButton extends View implements Checkable {

    private static final int DEFAULT_WIDTH = dp2pxInt(58);//default width
    private static final int DEFAULT_HEIGHT = dp2pxInt(36);//default height
